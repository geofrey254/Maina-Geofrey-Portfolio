          ...
          >
            <CarouselContent className="-ml-4 md:-ml-6">
              {DESIGN.map((proj) => (
                <CarouselItem
                  key={proj.id}
                  className="pl-4 md:pl-6 basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/3"
                >
            ...
            <div className="hidden md:block">
              <CarouselPrevious className="absolute -left-2 top-1/2 -translate-y-1/2 bg-white/90 border-2 hover:bg-white hover:scale-110 transition-all duration-200" />
              <CarouselNext className="absolute -right-2 top-1/2 -translate-y-1/2 bg-white/90 border-2 hover:bg-white hover:scale-110 transition-all duration-200" />
            </div>
